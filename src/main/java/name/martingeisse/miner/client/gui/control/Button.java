...
package name.martingeisse.miner.client.gui.control;
...
import name.martingeisse.miner.client.gui.element.MouseOverWrapper;
import name.martingeisse.miner.client.gui.element.NullElement;
import name.martingeisse.miner.client.gui.element.OverlayStack;
import name.martingeisse.miner.client.gui.element.PulseFillColor;
...
import name.martingeisse.miner.client.gui.util.PulseFunction;
