...
package name.martingeisse.miner.client.engine.renderer;
...
import name.martingeisse.miner.client.glworker.EnumWorkUnits;
import name.martingeisse.miner.client.glworker.FixedSubjectsWorkUnits;
