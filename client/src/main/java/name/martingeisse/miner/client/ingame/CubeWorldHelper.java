 ...
 *
 */
public class CubeWorldHelper {

	/**
	 * the logger
	 */
	private static Logger logger = Logger.getLogger(CubeWorldHelper.class);
	 ...
	 */
	public CubeWorldHelper(final int width, final int height) throws IOException {
	...
	public void step() {
		...
		// TODO properly disable all keyboard / mouse handling in the CubeWorldHelper when the GUI is active
		if (keysEnabled) {
			while (Keyboard.next()) {
